...
<h1 style="text-align:justify">please enter admin details</h1>
			<form method="post" class="form" action="admin_login_succ.php">
       ...
       <tr>
		...
		<tr><td><a href='#'>forget password</a></td><td><a href='reg.php'>sign up</a></td></tr>
		</table>
          </form>
			</div>
        </div>
