...
<head>
    ...
    <title>Wedding & Event Planner, Destination Weddings, Million Doller Moment Celebrations</title>
...
<!--  extea for other pages -->   
      <div class="clr"></div>
          <div id="page-sub-inside">   
            <img class="subpage-header-img" src="img/3.jpg" /> 
          </div>
	  <!-- end of extra -->
      <!--
...
<!-- Mirrored from m.colincowie.com/celebrations.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Jul 2016 07:40:55 GMT -->
</html>
